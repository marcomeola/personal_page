---
title: "Marco Meola"
image: "images/Meola_CV_crop.jpg"
site: distill::distill_website
links:
  #- label: '[`r fontawesome::fa("twitter")`](https://twitter.com/ciftciphd)'
  - label: '[`r fontawesome::fa("github")`](https://github.com/marcomeola)'
  - label: '[`r fontawesome::fa("linkedin")`](https://www.linkedin.com/in/marcomeola1/)'
  - label: '[`r fontawesome::fa("envelope")`](mailto:meolam2@gmail.com)'
  - label: '[**CV**](files/CV.html)'

preview: images/Meola_CV_crop.jpg
twitter:
  creator: "@marcomeola"
  site: "@marcomeola"
output:
